// src/pages/ResourcesDataAnalysis.tsx
import React from "react";
import { Link } from "react-router-dom";
import { resources } from "../data/Resources";

const ResourcesDataAnalysis: React.FC = () => {
  const dataAnalysisResources = resources.filter(
...
export default ResourcesDataAnalysis;
